	...
	function getHurtMix(){
			...
			innerContainer.style.webkitAnimationName = "innerContainerMix";
			innerContainer.style.mozAnimationName = "innerContainerMix";
			innerContainer.style.animationName = "innerContainerMix";
	...
	function getHurt6(){
		...
		function getHurt7(){
			...
			innerContainer.style.webkitAnimationName = "innerContainer3";
			innerContainer.style.mozAnimationName = "innerContainer3";
			innerContainer.style.animationName = "innerContainer3";
			...
			redLayer.style.webkitAnimationName = "redLayer3";
			redLayer.style.mozAnimationName = "redLayer3";
			redLayer.style.animationName = "redLayer3";
	...
	function lifeCount3(timestamp){
		var heartImage = document.getElementsByClassName("heart");

		if (332 > countTime){
			countTime ++;
			lifeDetect3 = requestAnimationFrame(lifeCount3);
		}
		if(98 === countTime){		
			live = live - 1;
			heartImage[2].style.filter = "brightness(20%)";
		...
		if (332 === countTime){
			...
			cancelAnimationFrame(lifeDetect3);
	...
	function lifeCountMix(timestamp){
		var heartImage = document.getElementsByClassName("heart");

		if (210 > countTime){
			countTime ++;
			lifeDetectMix = requestAnimationFrame(lifeCountMix);
		}
		if(99 === countTime){		
			live = live - 1;
			heartImage[2].style.filter = "brightness(20%)";
		...
		if(210 === countTime){
			...
			cancelAnimationFrame(lifeDetectMix);
	...
	function lifeCount4(timestamp){
		var heartImage = document.getElementsByClassName("heart");

		if (340 > countTime){
			countTime ++;
			lifeDetect4 = requestAnimationFrame(lifeCount4);
		}
		if(90 === countTime){		
			live = live - 1;
			heartImage[2].style.filter = "brightness(20%)";
		...
		if (340 === countTime){
			...
			cancelAnimationFrame(lifeDetect4);
	...
	function lifeCount5(timestamp){
		var heartImage = document.getElementsByClassName("heart");

		if (315 > countTime){
			countTime ++;
			lifeDetect5 = requestAnimationFrame(lifeCount5);
		}
		if(101 === countTime){		
			live = live - 1;
			heartImage[2].style.filter = "brightness(20%)";
	...
	function lifeCount6(timestamp){
		var heartImage = document.getElementsByClassName("heart");

		if (380 > countTime){
			countTime ++;
			lifeDetect6 = requestAnimationFrame(lifeCount6);
		}
		if(135 === countTime){		
			live = live - 1;
			heartImage[2].style.filter = "brightness(20%)";
	...
	function mouseDown(e) {
		...
		if (data === "attackBox5"){
			...
			cancelAnimationFrame(lifeDetect5);
		...
		if (data === "attackBox9"){
			...
			cancelAnimationFrame(lifeDetect6);
			stopHurt();
