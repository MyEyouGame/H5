...
(function() {
	...
	function createImage(){
		...
		{	 
			if(i <imageArray.length)
			{
				...
				charImage.setAttribute("src", imageArray[i]);	
				charImage.setAttribute("class","charImage");
				characterImage.appendChild(charImage);
			}
		}	
	...
	function characterAnimation(){
		var myIndex = 0;			
		var characterImage = document.getElementsByClassName("charImage");		
		loopCharacterImage();
		function loopCharacterImage(){
			var i;
			...
			renderAnimation = setTimeout(loopCharacterImage,100);			
	...
	// function characterAnimation2(){
		...
		// function loopCharacterImage(){
			...
			// if (myIndex > characterImage.length){}
			// characterImage[myIndex-1].style.display = "block";
			// renderAnimation = setTimeout(loopCharacterImage,140);			
